...
let storedTheme = localStorage.getItem('tyt_v4_theme');
let isDarkMode = storedTheme !== null ? storedTheme === 'dark' : true;
...
function applyCustomBackground(url) {
    ...
    if (url) {
        const overlay = isDarkMode ? 'rgba(26, 23, 21, 0.65), rgba(26, 23, 21, 0.85)' : 'rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0.6)';
        ...
        document.documentElement.style.setProperty('--custom-sub-bg', isDarkMode ? 'rgba(26, 23, 21, 0.85)' : 'rgba(255, 255, 255, 0.5)');
    } else {
        currentBgObjectUrl = null;
        document.documentElement.style.removeProperty('--custom-bg');
        document.documentElement.style.removeProperty('--custom-card-bg');
        document.documentElement.style.removeProperty('--custom-sub-bg');
    }
}
